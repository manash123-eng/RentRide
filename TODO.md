...
- [x] Update Express CORS config for production to remove wildcard origins and allow only https://rent-ride-eta.vercel.app and http://localhost:5173 with credentials=true.
